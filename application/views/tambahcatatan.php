  ...
  <div class="row">
   <div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10">
    ...
    <div class="contact-form wow fadeInUp" data-wow-delay="0.7s">
     <form action="<?php echo base_url(). 'DataKurban/tambahdata'; ?>" method="post">
      <input name="pemilik" type="text" class="form-control" placeholder="Pemilik Hewan" required>
      <input name="jenis_hewan" type="text" class="form-control" placeholder="Jenis Hewan" required>
